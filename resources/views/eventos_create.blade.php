        ...
        <div class="col-md-6"> 
            <div class="card border-0 shadow-lg">
                <div class="card-body p-3"> 
                    ...
                    <form action="{{ route('eventos.store') }}" method="POST" class="animate__animated animate__fadeInUp" onsubmit="showLoader()" id="crearEventoForm">
                        @csrf
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="nombre_evento" class="form-control form-control-lg @error('nombre_evento') is-invalid @enderror" placeholder=" " id="nombre_evento" value="{{ old('nombre_evento') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="date" name="dia_evento" class="form-control form-control-lg @error('dia_evento') is-invalid @enderror" placeholder=" " id="dia_evento" value="{{ old('dia_evento') }}">
                        ...
                        <div class="row mb-2"> 
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="number" id="cotizacion" name="precio_evento" class="form-control form-control-lg @error('precio_evento') is-invalid @enderror" placeholder=" " value="{{ old('precio_evento') }}" oninput="calcularResto()" min="0" inputmode="numeric">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="number" id="anticipo" name="anticipo" class="form-control form-control-lg @error('anticipo') is-invalid @enderror" placeholder=" " value="{{ old('anticipo') }}" oninput="calcularResto()" min="0" inputmode="numeric"disabled>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="number" id="resto" name="resto" class="form-control form-control-lg" placeholder=" " value="{{ old('resto') }}" readonly>
                        ...
                        <div class="mb-2"> 
                            <div class="form-floating">
                                <textarea class="form-control form-control-lg @error('descripcion_evento') is-invalid @enderror" style="height:100px" name="descripcion_evento" placeholder=" " id="descripcion_evento">{{ old('descripcion_evento') }}</textarea>
                        ...
                        <div class="mb-2"> 
                            <div class="form-floating">
                                <select name="estatus" class="form-select form-select-lg small-text @error('estatus') is-invalid @enderror" id="estatus">
                                    ...
                                    <option value="Concluido" {{ old('estatus') == 'Concluido' ? 'selected' : '' }}>Concluido</option>
                                    <option value="En Curso" {{ old('estatus') == 'En Curso' ? 'selected' : '' }}>En Curso</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="cliente_id" id="cliente_id" class="form-select form-select-lg small-text @error('cliente_id') is-invalid @enderror">
                                ...
                                @foreach($clientes as $cliente)
                                    <option value="{{ $cliente->id }}" {{ old('cliente_id') == $cliente->id ? 'selected' : '' }}>{{ $cliente->nombre_cliente }} - {{ $cliente->telefono_cliente }} - {{ $cliente->descripcion_cliente }}</option>
                                @endforeach
                            </select>
                            @error('cliente_id')
                                <div class="invalid-feedback">{{ $message }}</div>
